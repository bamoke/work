...
class GdpServiceHangyeModel extends BaseUploadModel
{
    protected $tableName = 'gdp_service_hangye';
    ...
    public function getList($condition, $type = "jw")
    {
        if ($type == "all") {
            ...
            $tableField = "title," . $type . "_gross as gross," . $type . "_rise as rise,measure";
        }
