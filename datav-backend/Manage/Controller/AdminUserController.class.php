...
class AdminUserController extends Auth
{
    ...
    public function getlist(){
        ...
        $result = $model
        ->alias("U")
        ->field("U.id,U.username,U.nickname,U.role_id,U.status,U.create_time,(select group_concat(name) from datav_admin_role R where FIND_IN_SET(R.id,U.role_id)) as role_name")
        ->where($where)
        ->page($page,$pageSize)
        ->fetchSql(false)
        ->select();
