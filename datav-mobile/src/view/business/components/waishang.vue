...
<template>
  <div class="content-wrap">
    ...
    <div class="l-row l-row-bt m-content-row">
      <div class="item-wrap">
        <ModuleCard title="国内部分区域实际吸收外商投资比较">
          <template v-slot:extra>
            <van-button
      ...
      <div class="item-wrap">
        <ModuleCard title="近一年实际吸收外商投资情况">
          <template v-slot:extra>
            <van-button
    ...
    <div class="l-row l-row-bt m-content-row">
      <div class="item-wrap">
        <ModuleCard title="近五年实际吸收外商直接投资情况">
          <template v-slot:extra>
            <van-button
              size="mini"
...
export default {
  ...
  mounted() {
    ...
    /***各镇指标 */
    Api.jjzb
      .get_town({ params: { cate: "实际吸收外商直接投资" } })
      .then((res) => {
        this.townData = {
          cmode: "gross",
          vmode: "chart",
    ...
    /***各区指标对比 */
    Api.jjzb
      .get_county({ params: { cate: "实际吸收外商直接投资" } })
      .then((res) => {
    ...
    /*** 国内部分区域指标 */
    Api.jjzb
      .get_domestic({ params: { cate: "实际吸收外商投资" } })
      .then((res) => {
