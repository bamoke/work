 ...
 * @LastEditTime: 2021-05-28 17:11:26
...
<template>
  <div
    ...
    id="theme-flat-dark"
  >
  <HeadBar item-bg-color="rgba(10, 70, 110, 1)"></HeadBar>
    <div class="content-wrap">
      ...
      <div class="row-big">
        ...
        <ModuleCard class="item-wrap">
          <template v-slot:extra>
            <div class="m-middle-slider-wrap" style="width:100%;">
...
export default {
  ...
  mounted() {
    ...
    const axisLabelColor = "#2a7ac1";
    const titleColor = "#5ea8e9";
...
<style lang="less" >
/****theme */
#theme-flat-dark .m-header-bar {
  background-color: transparent;
}
#theme-flat-dark .nav .link-item {
  background-color: rgba(10, 70, 110, 1);
}
#theme-flat-dark .m-module-card-wrap .bar .text {
  color:#5ddafe;
}
#theme-flat-dark {
  background-color: #031527;
  background-image: url(../../assets/images/index-banner-3.png);
  background-position: top center;
  background-repeat: no-repeat;
  background-size: contain;
}
#theme-flat-dark .m-module-card-wrap {
  background: rgba(10, 170, 250, 0.2)
  // color: #fff;
}
#theme-flat-dark .m-module-card-wrap .corner {
  width: 20px;
  height: 20px;
  border:none;
  background: url(../../assets/icon/corner-1.png);
  background-repeat: no-repeat;
  background-size: contain;
}
#theme-flat-dark .m-module-card-wrap .corner-top-right {
  transform: rotate(-90deg);
}
#theme-flat-dark .m-module-card-wrap .corner-top-left {
transform: rotate(-180deg);
}
#theme-flat-dark .m-module-card-wrap .corner-bottom-left {
  transform: rotate(-270deg);

}
#theme-flat-dark .m-module-card-wrap .bar {
  // background-color: rgba(0, 0, 0, 0.2);
  border-bottom: 1px solid #2a7ac1;
}
#theme-flat-dark .m-module-card-wrap .bar .ivu-icon {
  color:#5ddafe;
}
#theme-flat-dark .m-module-card-wrap .bar .extra {
  flex-grow: 1;
}
#theme-flat-dark .row-big {
  position: absolute;
  left:25.5%;
  bottom:46px;
  width:49%;
