 ...
 * @LastEditTime: 2021-06-02 08:14:32
    ...
    <div class="row-side side-right">
      <div class="transform-box">
        <ModuleCard
          ...
          class="item-wrap"
        >
          <div id="chart-caizhengshouru" class="h-large"></div>
        </ModuleCard>
        <ModuleCard
          title="一般公共预算支出"
          ...
          class="item-wrap"
        >
          <div id="chart-caizhengzhichu" class="h-large"></div>
        </ModuleCard>
        <ModuleCard
          title="社会消费品零售总额"
...
export default {
  components: { EffectCircle, ChartPie3D },
  data() {
    return {
      sliderIndex: 0,
      echartInstance: {},
  ...
  methods: {
    ...
    chartInit({ themeName = this.$config.chartTheme, chartName = [] }) {
      /**图表初始化 */
      var echartInstance = {};
      const echart = this.$echarts;
      chartName.forEach(function (item, index) {
        echartInstance[item] = echart.init(
  ...
  mounted() {
              ...
              normal: {
                color: new this.$echarts.graphic.LinearGradient(
                  ...
                  [
                    {
                      offset: 0,
                      color: "rgba(30,255,200,0.7)",
                    },
                    {
                      offset: 1,
                      color: "rgba(30,255,200,0)",
                    },
                  ],
                  false
                ),
                shadowColor: "rgba(30,255,200, 0.9)",
                shadowBlur: 20,
              },
            },
          },
    ...
    baseApi.get_ggys().then((res) => {
      ...
      // 税收
      this.echartInstance.caizhengshouru.setOption({
      ...
      // 公共服务支出
      this.echartInstance.caizhengzhichu.setOption({
        ...
        series: [
          {
            ...
            symbolSize: 4,
            itemStyle: {
              color: "rgba(30,255,200,1)",
              borderColor: "#fff",
              borderWidth: 4,
              shadowColor: "rgba(30,255,200,1)",
              shadowBlur: 6,
            },
            areaStyle: {
              normal: {
