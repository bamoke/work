<template>
  <div>
    ...
    <Modal ref="userform-modal" v-model="showForm" draggable scrollable >
        ...
        <UserForm v-show="formActype == 'edit'" :userFormInfo="formDetail" :actype="formActype" :groups-arr="groupsArr" @handle-submit="handleFormSubmit" @handle-cancel="handleFormCancel" />
        <UserForm v-show="formActype == 'add'" :actype="formActype" :groups-arr="groupsArr" @handle-submit="handleFormSubmit" @handle-cancel="handleFormCancel" />
        <p slot="footer"></p>
    </Modal>
  </div>
</template>
