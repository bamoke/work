  ...
  <div class="module-body">
    ...
    <div class="member-list-wrap">
      <Card :bordered="false" dis-hover>
        ...
        :title="modalTitle"
        >
        <MemberForm @on-cancel="handleCloseModal" @on-success="handleCompleted" :department-list="department" v-show="modalContent === 'add'"></MemberForm>
        <SettingModule @on-cancel="handleCloseModal" @on-success="handleUpdateBase" :department-list="department" :id="curEditMember.id" v-show="modalContent === 'setting'"></SettingModule>
...
import MemberForm from './components/main-form.vue'
import SettingModule from './components/setting'
export default {
  components: { MemberForm, SettingModule },
  data () {
    return {
      columns: [
        {
