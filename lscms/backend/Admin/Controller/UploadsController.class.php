...
class UploadsController extends Auth {
  ...
  public function save(){
    $upload_conf=array(
      ...
      'savePath' => 'images/',
      'saveName' => time().$this->userInfo['id'],
    ...
    if($_FILES['img']['tmp_name']){
        ...
        if(!$uploadResult){
          ...
          $backData = array(
            "code"  =>200,
            "errno" =>0,
            "data"=>array(__ROOT__."/Uploads/images/".$uploadResult['savename']),//完整url
            "filename"=>$uploadResult['savename'] //oss 文件名包括目录
          );
  ...
  public function delete(){
    ...
    $file = ROOT_DIR.'/Uploads/images/'.$fileName;
    if(unlink($file)) {
      $backData = array(
        "code"  =>200,
        "msg"   =>"success"
