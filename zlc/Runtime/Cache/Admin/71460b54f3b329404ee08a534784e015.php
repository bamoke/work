...
<div class="g-wrap">
    ...
    <div class="panel-body">
        <div class="u-page-title">
            <span class="caption">添加文章</span>
        </div>
        <form name="news-form" class="form form-horizontal" action="<?php echo U('save',array('pid'=>$_GET['pid']));?>">
            <input type="hidden" name="cid" value="<?php echo ($cid); ?>">
            <div class="form-group">
                <label class="control-label col-xs-2">
                    <span class="text-danger">*</span>文章标题:</label>
                <div class="col-xs-4">
                    <input type="text" name="title" class="form-control" value="" placeholder="建议12个字符以内">
                </div>
                <div class="col-xs-3 js-tips"></div>
            </div>
            <div class="form-group">
                <label class="control-label col-xs-2">
                    <span class="text-danger">*</span>封面:</label>
                <div class="col-xs-3">
            ...
            <div class="form-group">
                <label class="control-label col-xs-2">视频地址:</label>
                <div class="col-xs-4">
            ...
            <div class="form-group">
                <label class="control-label col-xs-2">其他设置:</label>
                <div class="col-xs-7">
                    <label class="radio-inline">
                        <input type="radio" name="otherset" value="1" />人气</label>
                    <label class="radio-inline">
                        <input type="radio" name="otherset" value="2" />热搜</label>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="control-label col-xs-2">来源:</label>
                <div class="col-xs-4">
            ...
            <div class="form-group">
                <label class="control-label col-xs-2">关键词:</label>
                <div class="col-xs-6">
                    <input type="text" name="keywords" class="form-control" value="" placeholder="关键词用','隔开">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-xs-2">文章描述:</label>
                <div class="col-xs-6">
