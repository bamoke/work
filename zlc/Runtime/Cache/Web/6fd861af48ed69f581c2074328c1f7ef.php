  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-9" id="bigContentBox">
        ...
        <div class="m-content-wrap"><ul class="m-imgtext m-imgtext-big">
        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><li class="item">
                        <a href="<?php echo U('detail',array('cid'=>$vo['cid'],'id'=>$vo['id']));?>" class="img-box">
                        ...
                        <div class="text-box">
                            ...
                            <div class="u-statistics">
                                <span class="view"><?php echo ($vo['click']); ?></span>
